...
--
-- Host: 127.0.0.1
-- Generation Time: Sty 03, 2024 at 05:54 PM
...
INSERT INTO `cart` (`id`, `nazwa`, `cena`, `ilosc`) VALUES
(0, 'ananas', 33, 5);
...
INSERT INTO `products` (`id`, `nazwa`, `kategoria`, `opis`, `data_utworzenia`, `data_modyfikacji`, `data_wygasniecia`, `cena_netto`, `podatek_vat`, `ilosc_sztuk`, `dostepnosc`, `img`) VALUES
(1, 'ananas', 'Owoc', 'Owoc-opis', '2023-12-12', '2023-12-18', '2024-01-28', 10, 23, 144, 1, 'https://bazarekpolski.pl/wp-content/uploads/2020/10/ananas-600x600.jpg');
