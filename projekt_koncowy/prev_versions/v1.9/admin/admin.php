...
//rozpoczecie sesji na stronie
session_start();

// zawarcie metodami require i include plikow z konfiguracja
// strony i pokazaniem strony przez sql_query
require "../cfg.php";
...
//plik css 'form.css' - styl formularzy
...
//               FormularzLogowania                //
//-------------------------------------------------//
//    Funkcja tworzaca formularz do logowania      //
//-------------------------------------------------//
...
// Logowanie sie po wczytaniu zmiennych typu post 'x1_submit',
// 'login_email' i 'login_pass' z formularza
if (isset($_POST['x1_submit'])) {
    if ($_POST['login_email'] == $login && $_POST['login_pass'] == $pass)
    {
        ...
        echo "Witaj, ".$login."!</br>";
        ListaPodstron();
        echo '<a href="categories.php"<button class="logowanie"><h3>Przejdz do zarzadzania kategoriami</h3></button></a>';
    }
    else
    {
...
//               ListaPodstron                     //
//-------------------------------------------------//
//    Funkcja wyswietlająca liste podstron         //
//-------------------------------------------------//
...
//               DodajNowaPodstrone                //
//-------------------------------------------------//
//         funkcja dodajaca nowa podstrone         //
//-------------------------------------------------//
...
// uzycie zmiennej $_SERVER["REQUEST_METHOD"] na zmienna typu 'POST'
// do wczytania danej funkcji
