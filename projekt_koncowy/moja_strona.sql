...
--
-- Host: 127.0.0.1
-- Generation Time: Sty 10, 2024 at 11:05 AM
...
CREATE TABLE `products` (
  ...
  `price_netto` int(11) DEFAULT NULL,
  `tax_vat` int(11) DEFAULT NULL,
...
INSERT INTO `products` (`id`, `title`, `description`, `date_add`, `date_edit`, `date_expire`, `price_netto`, `tax_vat`, `quantity`, `availability`, `category`, `dimensions`, `image`) VALUES
(4, 'Banann', 'banan-opis', '2024-01-09', NULL, '2024-01-28', 555, 3, 300, 1, 'Owoce', '30x30', 'https://cdn.galleries.smcloud.net/t/galleries/gf-4Mo5-uPSk-WnPj_banany-wlasciwosci-i-wartosci-odzywcze-jakie-witaminy-maja-banany-1920x1080-nocrop.jpg'),
(11, 'test', 'test', '2024-01-10', NULL, '2024-01-27', 555, 10, 500, 1, 'test', '100x100', 'https://st3.depositphotos.com/23594922/31822/v/450/depositphotos_318221368-stock-illustration-missing-picture-page-for-website.jpg');
